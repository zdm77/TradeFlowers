object FrameProduct: TFrameProduct
  ...
  object lstTreeProducts: TcxDBTreeList
    ...
    RootValue = -1
    Styles.OnGetContentStyle = lstTreeProductsStylesGetContentStyle
    TabOrder = 1
  ...
  inline FrameSearch1: TFrameSearch
    ...
    inherited Group1: TcxGroupBox
      ...
      inherited edtName: TcxTextEdit
        Left = 43
        OnKeyDown = FrameSearch1edtNameKeyDown
        ExplicitLeft = 43
        ExplicitWidth = 190
        Width = 190
      end
  ...
  object QueryProduct: TUniQuery
    ...
    SQL.Strings = (
      ...
      'order by id')
    BeforeFetch = QueryProductBeforeFetch
    AfterFetch = QueryProductAfterFetch
    Left = 127
    Top = 261
  end
