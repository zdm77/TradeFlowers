...
begin
  ...
  begin
    ...
    begin
      ...
      EnableAdd;
      case FPasswd.Lang of
        0 : edtPricooling.Text := QuerySelect.FieldByName('name').AsString;
        1 : edtPricooling.Text := QuerySelect.FieldByName('uni_name').AsString;
        2 : edtPricooling.Text := QuerySelect.FieldByName('reg_name').AsString;
      end;
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      EnableAdd;
      case FPasswd.Lang of
        0 : edtTrack.Text := QuerySelect.FieldByName('name').AsString;
        1 : edtTrack.Text := QuerySelect.FieldByName('uni_name').AsString;
        2 : edtTrack.Text := QuerySelect.FieldByName('reg_name').AsString;
      end;
    end;
  end;
end;
...
begin
  if (TransactOrder.Active = false) then
    TransactOrder.StartTransaction;
  case FPasswd.edtLang.ItemIndex of
    0 : if QueryOrderDetail.FieldByName('запрет_покупки').AsBoolean = false then
    ...
    1 : if QueryOrderDetail.FieldByName('запрет_покупки').AsBoolean = false then
    ...
    2 : if QueryOrderDetail.FieldByName('запрет_покупки').AsBoolean = false then
...
begin
  ...
  begin
    ...
    Open;
    case FPasswd.Lang of
      0 : edtFito.Properties.ListFieldNames := 'name';
      1 : edtFito.Properties.ListFieldNames := 'uni_name';
      2 : edtFito.Properties.ListFieldNames := 'reg_name';
    end;
    if s_id_fito <> 0 then
