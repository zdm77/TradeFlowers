object FrameSort: TFrameSort
  ...
  object GroupType: TcxGroupBox
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        object ColumnUseName: TcxGridDBColumn
  ...
  object GroupSelCountry: TcxGroupBox
    ...
    object edtCountry: TcxLookupComboBox
      ...
      Properties.OnEditValueChanged = edtCoutryPropertiesEditValueChanged
  ...
  object QueryType: TUniQuery
    ...
    Connection = DM1.db1
    SQL.Strings = (
      'select * from "'#1087#1088#1086#1076#1091#1082#1094#1080#1103'"."'#1090#1080#1087#1099'" where id=1')
    Left = 143
    Top = 273
  end
  ...
  object Query1: TUniQuery
    ...
    SQL.Strings = (
      'SELECT '
      ' s*,'
      '  ss."'#1082#1086#1076'_'#1089#1090#1088#1072#1085#1099'"'
      'FROM'
      '  "'#1087#1088#1086#1076#1091#1082#1094#1080#1103'"."'#1089#1086#1088#1090#1072'" s'
      '  INNER JOIN "'#1087#1088#1086#1076#1091#1082#1094#1080#1103'"."'#1090#1080#1087#1099'" t ON (s."'#1082#1086#1076'_'#1090#1080#1087#1072'" = t.id)'
      
        '  INNER JOIN "'#1087#1088#1086#1076#1091#1082#1094#1080#1103'"."'#1089#1086#1088#1090'_'#1089#1090#1088#1072#1085#1072'" ss ON (s.id = ss."'#1082#1086#1076'_'#1089#1086#1088 +
        #1090#1072'")'
      'where  ss."'#1082#1086#1076'_'#1089#1090#1088#1072#1085#1099'"=:'#1082#1086#1076'_'#1089#1090#1088#1072#1085#1099)
    Left = 475
    Top = 173
    ParamData = <
      item
        DataType = ftUnknown
        Name = #1082#1086#1076'_'#1089#1090#1088#1072#1085#1099
        Value = nil
      end>
  end
  ...
  object Transact2: TUniTransaction
    DefaultConnection = DM1.db1
    Left = 304
    Top = 244
  end
  object Dialog1: TAdvTaskDialog
    CommonButtons = []
    DefaultButton = 0
  ...
  object QueryCountry: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select * from "'#1087#1088#1086#1076#1091#1082#1094#1080#1103'"."'#1087#1088#1086#1076#1091#1082#1094#1080#1103'" where '#1082#1086#1076'_'#1089#1090#1088#1091#1082#1090#1091#1088#1099' in (2,' +
        '3) order by id')
    Left = 135
    Top = 153
  end
