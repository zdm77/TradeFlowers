...
begin
  ...
  case FPasswd.Lang of
    0 : col_uni_name.Caption := 'Международное';
    1 : col_uni_name.Caption := 'International';
    2 : col_uni_name.Caption := 'Internacional';
  end;
  { русское имя }
  case FPasswd.Lang of
    0 : col_name.Caption := 'Русское';
    1 : col_name.Caption := 'Russian';
    2 : col_name.Caption := 'Ruso';
  end;
  { испанское имя }
  case FPasswd.Lang of
    0 : col_reg_name.Caption := 'Региональное';
    1 : col_reg_name.Caption := 'International';
    2 : col_reg_name.Caption := 'Regional';
  end;
end;
end.
