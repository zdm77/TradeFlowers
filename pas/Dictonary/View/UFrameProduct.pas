...
begin
  ...
  begin
    ...
    begin
      case FPasswd.edtLang.ItemIndex of
        0 : ErrorDialog('Добавление невозможно.', '',
                         'Все уникальные свойства уже выбраны.');
        1 : ErrorDialog('Adding it is impossible to.', '',
                         'All of the unique properties of the already selected.');
        2 : ErrorDialog('La adición es imposible.', '',
  ...
  begin
    case FPasswd.edtLang.ItemIndex of
      0 : ErrorDialog('Добавление невозможно.', '', 'Необходимо выбрать сорт.');
      1 : ErrorDialog('Adding it is impossible to.', '',
...
begin
  ...
  begin
    case FPasswd.edtLang.ItemIndex of
      0 : ErrorDialog('Позиция не скрыта. Удаление не возможно.', '', '');
      1 : ErrorDialog
