object FrameTopPanel: TFrameTopPanel
  ...
  object pmПедидо: TdxBarPopupMenu
    ...
    ItemLinks = <
      ...
      item
        Visible = True
        ItemName = 'btn'#1047#1072#1082#1091#1087#1082#1072
      end>
    UseOwnFont = False
    Left = 224
    Top = 68
  end
  object pmЗаказ: TdxBarPopupMenu
    BarManager = barProduct
    ItemLinks = <
      item
        Visible = True
        ItemName = 'btn'#1047#1072#1082#1072#1079
      end>
    UseOwnFont = False
    Left = 332
    Top = 60
  end
  object pmФактура: TdxBarPopupMenu
    BarManager = barProduct
    ItemLinks = <>
    UseOwnFont = False
    Left = 424
  ...
  object pmClients: TdxBarPopupMenu
    BarManager = barProduct
    ItemLinks = <
      item
        Visible = True
        ItemName = 'btnReportClients'
      end
      item
        Visible = True
        ItemName = 'btnCardClient'
      end>
    UseOwnFont = False
    Left = 528
    Top = 64
